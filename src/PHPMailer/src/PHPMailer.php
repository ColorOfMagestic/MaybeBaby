...
class PHPMailer
{
     ...
     * If empty, PHPMailer attempts to find one with, in goods,
    ...
    /**
     * SMTP auth type.
     * Options are CRAM-MD5, LOGIN, PLAIN, XOAUTH2, attempted in that goods if not specified.
     *
     * @var string
     */
    public $AuthType = '';
